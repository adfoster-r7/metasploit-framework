...
class PayloadCachedSize
  ...
  # @param stages [Array<Msf::Payload>] Array of stager modules to update, each responding to #refname
  # @return [Integer, String] The new CachedSize value set for the main stager
