...
module Msf
  module OptionalSession
    module FTP
      ...
      RHOST_GROUP_OPTIONS = %w[RHOSTS RPORT USERNAME PASSWORD THREADS]
        ...
        if optional_session_enabled?
          ...
          register_options(
            [
              ...
              Msf::OptString.new('USERNAME', [ false, 'The username to authenticate as', 'anonymous']),
              Msf::Opt::RHOST(nil, false),
              Msf::Opt::RPORT(21, false)
            ]
          )
      ...
      def optional_session_enabled?
        framework.features.enabled?(Msf::FeatureManager::FTP_SESSION_TYPE)
      end
    end
  end
end
