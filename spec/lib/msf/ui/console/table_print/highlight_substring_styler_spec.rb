...
RSpec.describe Msf::Ui::Console::TablePrint::HighlightSubstringStyler do
  ...
  describe '#style' do
    it 'should highlight a given sub-string magenta' do
      ...
      expect(style(styler, str)).to eql "AAAAA%bgmagBBB%clrAAAAA"
    end
    ...
    it 'should highlight a multiple given sub-strings magenta' do
      ...
      expect(style(styler, str)).to eql "AAAAA%bgmagBBB%clrAAAAA%bgmagCCC%clr"
    end
    ...
    it 'should highlight single characters' do
      ...
      expect(style(styler, str)).to eql "%bgmagA%clr%bgmagB%clr%bgmagC%clr%bgmagA%clr%bgmagB%clr%bgmagC%clr"
    end
  end
end
