...
class MetasploitModule < Msf::Auxiliary
  ...
  def createfilecontent
    ...
    open(File.join(Msf::Config.install_root, 'data', 'exploits', 'badodt', 'content.xml'), 'w') do |f|
    ...
    open(File.join(Msf::Config.install_root, 'data', 'exploits', 'badodt', 'meta.xml'), 'w') do |f|
