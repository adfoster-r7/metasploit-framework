...
class MetasploitModule < Msf::Auxiliary
  ...
  def run
    ...
    name1 = Rex::Text.rand_text_alpha_upper(rand(1..10))
    name2 = Rex::Text.rand_text_alpha_upper(rand(1..10))
    rand1 = Rex::Text.rand_text_alpha_upper(rand(1..10))
    rand2 = Rex::Text.rand_text_alpha_upper(rand(1..10))
    rand3 = Rex::Text.rand_text_alpha_upper(rand(1..10))
